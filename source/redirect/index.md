  ...
  if (goto) {
    try {
      ...
      document.getElementById('target-info').innerHTML = `
        ...
        <p>连接类型：${protocol === 'failed' ? '连接超时，可能无法打开页面。' : protocol}</p>
